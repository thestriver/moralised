                ...
                <div class="row">
                  <div class="col-lg-7 col-xl-5">
                    <div class="text-container">
                      ...
                      <p class="p-large">
                        Your minimalist ETH dashboard. See your last transactions, gas
                        fees and tokens balance.
                      </p>
                      <buttom class="btn-outline-lg" onClick={onLogin}>
                        Login
                      </buttom>
                    </div>
                  </div>
                  <div class="col-lg-5 col-xl-7 rounded">
                    <div class="image-container ">
                      <img class="img-fluid rounded" src={img2} alt="alternative" />
                    </div>
                  </div>
                </div>
              </div>
